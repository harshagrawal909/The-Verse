            ...
            <div className="flex flex-col items-center w-full px-8">
                ...
                <form className="w-full space-y-4 px-4" onSubmit={handleLogin}>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border-1 border-[#DEE1E6FF] rounded-md shadow-sm text-sm"
                                    value={user.email}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    id="password"
                                    placeholder="••••••••"
                                    className="w-full pl-10 pr-10 py-2 border-1 border-[#DEE1E6FF] rounded-md shadow-sm text-sm"
                                    minLength={8}
                                    value={user.password}
                        ...
                        <div className="text-center pt-1 pb-2">
                            <Link href="/forgot-password" className="text-sm font-medium hover:underline text-[#636AE8FF]">
                                Forgot password?
                            </Link>
                        </div>
                        <button
                ...
                <div className="mt-8 text-sm">
                    ...
                    <Link href="/signup" className="text-[#636AE8FF] font-medium hover:underline ml-1">
                        Sign Up
                    </Link>
                </div>
